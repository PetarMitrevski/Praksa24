...
<header class="container-fluid">
   ...
   <nav class="navbar navigation">
      ...
      <form action="../configs/editMatchData.php"  method="post">
<fieldset>
            
             <div>
              <label>Week:</label>
              <input name="identifier" type="hidden" value="<?= $result["matchID"]; ?>" />
              <input disabled min="1"  name="Week" type="number" value="<?= $result["week"]; ?>"/>
              </div>
 
              <div>
              <label>Home Team:</label>
              <input disabled value="<?= $result["teamHome"]; ?>"/>
              </div>
 
              <div>
              <label>Away Team:</label>
              <input disabled value="<?= $result["teamAway"]; ?>"/>
              </div>
              
              <div>
              <label>Home Score:</label>
              <input min="0" required name="Home_score" type="number" placeholder="Score" value="<?=$result["HomeScore"]; ?>"/>
              </div>
              
              <div>
              <label>Away Score:</label>
              <input min="0" required name="Away_score" type="number" placeholder="Score" value="<?=$result["AwayScore"]; ?>"/>
              </div>
              
              <div>
              <label>Match Date:</label>
              <input disabled name="Match_date" type="date" value="<?=$result["matchDate"]; ?>"/>
              </div>
              
              <div>
              <label>Match Time:</label>
              <input disabled name="Match_time" type="time" value="<?=$result["matchStart"]; ?>"/>
              </div> 
