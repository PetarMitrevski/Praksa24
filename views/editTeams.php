...
<form action="../configs/editTeamData.php"  method="post">
            <fieldset>
             
            <div>
            <input name="id" type="hidden" placeholder="Team" value="<?= $team["teamID"]; ?>">
            <div>
             <label>Team:</label>
             <input name="Team" pattern="[A-Za-z\s]+" value=<?= $team["TeamName"]; ?> type="text"/>
             </div>
             </div>

             <div>
             <label>Home Wins:</label>
             <input min="0" value=<?= $team["HomeWins"]; ?> required name="Home_Wins" type="number" placeholder="Home Wins"/>
             <br>
             <label>Away Wins:</label>
             <input min="0" value=<?= $team["AwayWins"]; ?> required name="Away_Wins" type="number" placeholder="Away Wins"/>
             </div>

             <div>
             <label>Home Draws:</label>
             <input min="0" value=<?= $team["HomeDraws"]; ?> required name="Home_Draws" type="number" placeholder="Home Draws"/>
             <br>
             <label>Away Draws:</label>
             <input min="0" value=<?= $team["AwayDraws"]; ?> required name="Away_Draws" type="number" placeholder="Away Draws"/>
             </div>
             
             <div>
             <label>Home Losses:</label>
             <input min="0" value=<?= $team["HomeLosses"]; ?> required name="Home_Losses" type="number" placeholder="Home Losses"/>
             <br>
             <label>Away Losses:</label>
             <input min="0" value=<?= $team["AwayLosses"]; ?> required name="Away_Losses" type="number" placeholder="Away Losses"/>
             </div> 
